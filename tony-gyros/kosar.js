// Kosár oldal JavaScript - JAVÍTOTT (Stabil Email Küldés + Utólagos kedvezmény)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ==================== JAVÍTOTT EMAIL KÜLDÉS (AJAX) ====================
    
    // Ez a függvény már nem form.submit()-ot használ, hanem AJAX kérést.
    // Ez megakadályozza, hogy az oldal újratöltődjön/navigáljon még az adatok elküldése előtt.
    async function sendOrderEmail(orderData) {
        ...
        try {
            ...
            if (response.ok) {
                ...
                console.error('Szerver hiba válasz:', await response.text());
                return false;
            }
        } catch (error) {
...
Email: info@tonygyros.hu`;
    ...
    // ==================== JAVÍTOTT RENDELÉS LEADÁSA GOMB ====================
